...
class Battery(PowerSource):
    ...
    @property
    def present(self):
        return self._read_bool('present')

    ##############################################

    @property
    def technology(self):
        return self._read('technology')

    ##############################################

    @property
    def cycle_count(self):
        return self._read_int('cycle_count')

    ##############################################

    @property
    def voltage_min_design(self):
        return self._read_int('voltage_min_design')

    ##############################################

    @property
    def voltage_now(self):
        return self._read_int('voltage_now')

    ##############################################

    @property
    def power_now(self):
        return self._read_int('power_now')

    ##############################################

    @property
    def energy_full_design(self):
        return self._read_int('energy_full_design')

    ##############################################

    @property
    def energy_full(self):
        return self._read_int('energy_full')

    ##############################################

    @property
    def energy_now(self):
        return self._read_int('energy_now')

    ##############################################

    @property
    def capacity(self):
        return self._read_int('capacity')

    ##############################################

    @property
    def model_name(self):
        return self._read('model_name')
    ...
    def serial_number(self):
        return self._read('serial_number')
